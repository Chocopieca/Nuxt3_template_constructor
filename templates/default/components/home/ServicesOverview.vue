<template>
  <section class="services-overview py-24 bg-gray-100">
    <div class="container max-w-7xl mx-auto px-4">
      <h2 class="text-4xl font-bold text-center mb-16 text-gray-800">{{ t('homePage.services.title') }}</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

        <AppCard class="group transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
          ...
          <h3 class="text-2xl font-semibold mb-4 text-gray-800 group-hover:text-warning-500 transition-colors duration-300">
            {{ t('components.service.0.title') }}
          </h3>
          <p class="text-gray-600 mb-6 leading-relaxed">
            {{ t('components.service.0.description') }}
          </p>
          <NuxtLink 
            :to="SERVICE_ROUTES[SERVICES.WEB_DESIGN]"
          ...
          >
            {{ t('components.service.0.linkText') }}
        ...
        <AppCard class="group transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
          ...
          <h3 class="text-2xl font-semibold mb-4 text-gray-800 group-hover:text-warning-500 transition-colors duration-300">
            {{ t('components.service.1.title') }}
          </h3>
          <p class="text-gray-600 mb-6 leading-relaxed">
            {{ t('components.service.1.description') }}
          </p>
          <NuxtLink 
            :to="SERVICE_ROUTES[SERVICES.BRAND_IDENTITY]"
            class="text-yellow-500 hover:text-yellow-600 font-semibold inline-flex items-center group/link relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-yellow-500 hover:after:w-full after:transition-all after:duration-300"
          >
            {{ t('components.service.1.linkText') }}
            <span class="ml-2 transform group-hover/link:translate-x-1 transition-transform">→</span>
          </NuxtLink>
        </AppCard>
        ...
        <AppCard class="group transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
          ...
          <h3 class="text-2xl font-semibold mb-4 text-gray-800 group-hover:text-warning-500 transition-colors duration-300">
            {{ t('components.service.2.title') }}
          </h3>
          <p class="text-gray-600 mb-6 leading-relaxed">
            {{ t('components.service.2.description') }}
          </p>
          <NuxtLink 
            :to="SERVICE_ROUTES[SERVICES.UI_UX_DESIGN]"
            class="text-yellow-500 hover:text-yellow-600 font-semibold inline-flex items-center group/link relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-yellow-500 hover:after:w-full after:transition-all after:duration-300"
          >
            {{ t('components.service.2.linkText') }}
            <span class="ml-2 transform group-hover/link:translate-x-1 transition-transform">→</span>
          </NuxtLink>
        </AppCard>
      </div>
      <div class="text-center mt-16">
        ...
        >
          {{ t('homePage.services.buttonText') }}
        </NuxtLink>
      </div>
    </div>
  </section>
